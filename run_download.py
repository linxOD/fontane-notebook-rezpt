...
#          ".//tei:sourceDoc//tei:surface", ".//tei:sourceDoc//tei:add", 
#          ".//tei:sourceDoc//tei:zone", ".//tei:sourceDoc//tei:line", 
#          ".//tei:sourceDoc//tei:seg", ".//tei:abstract",
#          ]
# xpath = [".//tei:sourceDesc//tei:list[@type='editorial']/tei:item",
...
# xpath = [".//tei:sourceDoc//tei:rs", ".//tei:sourceDoc//tei:date", ".//tei:sourceDoc//tei:ref"]
xpath = [".//tei:sourceDoc//tei:note[@type='editorial']", 
         ".//tei:sourceDoc//tei:note[@type='authorial']", 
         ".//tei:sourceDoc//tei:surface", ".//tei:sourceDoc//tei:add", 
         ".//tei:sourceDoc//tei:zone", ".//tei:sourceDoc//tei:line", 
